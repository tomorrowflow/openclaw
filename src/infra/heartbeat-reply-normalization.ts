/**
 * Heartbeat reply normalization: strips the response prefix, heartbeat and
 * silent tokens, and internal stream-error placeholders before delivery
 * classification decides what to do with the result.
 */
