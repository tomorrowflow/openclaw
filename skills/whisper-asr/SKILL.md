---
name: whisper-asr
description: Local CPU-only speech-to-text via a Whisper ASR WebService on http://127.0.0.1:9009 running faster-whisper, with an FFmpeg API on http://127.0.0.1:9008 for audio conversion. Use when an agent needs to transcribe a voice message or audio file.
---
